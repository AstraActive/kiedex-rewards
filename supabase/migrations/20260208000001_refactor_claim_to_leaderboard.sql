...
-- Rewards are available to claim after 03:10 UTC until 03:09:59 next day
...
BEGIN
  ...
  -- Claim window: 03:10:00 UTC on (date + 1 day) until 03:09:59 UTC on (date + 2 days)
  v_claim_window_start := (p_claim_date + INTERVAL '1 day')::DATE + TIME '03:10:00';
  v_claim_window_end := (p_claim_date + INTERVAL '2 days')::DATE + TIME '03:09:59';
  ...
  IF v_now < v_claim_window_start THEN
    RETURN QUERY SELECT 
      ...
      0::NUMERIC, 
      0::NUMERIC, 
      'Rewards not yet available. Claim window opens at 03:10 UTC.'::TEXT;
    RETURN;
  END IF;
...
Claim window: 03:10 UTC day after trading until 03:09:59 UTC two days after trading.';

-- Example usage:
-- Claim rewards for trading done on 2026-02-07 (can claim from 2026-02-08 03:10 UTC to 2026-02-09 03:09:59 UTC)
